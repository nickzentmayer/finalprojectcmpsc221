...
public class ShowStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println("<h1>Student Information</h1>");
        File f = new File("/Users/nickzentmayer/Documents/CMPSC 221/student_info.csv");
        if(f.exists()) {
        ...
        response.getWriter().println("<th>Academic Level</th>");
        response.getWriter().println("<th>Start Semester</th>");
        response.getWriter().println("</tr>");
        ...
        else response.getWriter().println("<p style=\"color: red;\">student_info.csv not found</p>");
